...
DATAFILEPATH="Donnees_Projet_Python_Dev_Data.csv"
NBREDISPLAYLINE=5



DATA_BASE_RENDER=[ ]
Data_Base=DATA_BASE_RENDER=[]


def readDataFileToListDict(filePath:str="")->list:
    # DataBaseRender=[]
    with open (filePath,"r", encoding="utf-8") as file:
        ...
        # for i in lines :
            # Data_Base.append(i)
        # print(list(lines))
        # return [lines[i] for i in range(len(list(lines)))]
    # print(type(Data_Base[:5]))
    # return Data_Base
        # DataBaseRender=list(lines)
    # return DataBaseRender
    
DATA_BASE_RENDER=readDataFileToListDict(DATAFILEPATH)


#Affichage des 5 premieres Lignes-----------------------------------------------------------------------------------------------
for i in range(NBREDISPLAYLINE):
    print(json.dumps(DATA_BASE_RENDER[i],ensure_ascii=False,indent=8))
